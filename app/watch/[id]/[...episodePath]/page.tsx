      ...
      <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
        ...
        <div className="flex-grow">
          ...
          <div className="flex items-center gap-2 text-xs md:text-sm text-gray-400 mb-4 overflow-hidden whitespace-nowrap">
            ...
            <span>/</span>
            <span className="text-white">Episode {currentEpisode?.number || 'Memutar'}</span>
          </div>

          {/* Video Player */}
          <div className="relative aspect-video bg-black rounded-lg overflow-hidden shadow-2xl border border-[#2a2c2e] -mx-4 md:mx-0">
            {sources.sources?.[0]?.url ? (
                ...
                <div className="absolute inset-0 flex items-center justify-center text-center p-6">
                    <div>
                        <p className="text-xl font-bold mb-2">Sumber video tidak dapat disematkan</p>
                        <p className="text-gray-400 mb-6">Coba tonton langsung di sumbernya atau periksa episode lain.</p>
                        {sources.sources?.[0]?.url && (
                            <a
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-[#1a1c1e] p-4 rounded-lg border border-[#2a2c2e]">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-center">
              {prevEpisode && (
                <Link
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-[#2a2c2e] hover:bg-primary hover:text-black rounded transition-colors text-sm font-bold"
          ...
          <div className="mt-8">
            ...
            <div className="bg-[#1a1c1e] p-6 rounded-lg border border-[#2a2c2e]">
                ...
                <div className="mt-4 pt-4 border-t border-[#2a2c2e] flex flex-wrap gap-4 text-xs font-medium uppercase tracking-wider text-gray-500">
                    ...
                    <div>Tipe: <span className="text-white">{anime.type}</span></div>
                    <div>Rilis: <span className="text-white">{anime.releaseDate}</span></div>
                </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-80 flex-shrink-0">
          <div className="bg-[#1a1c1e] rounded-lg border border-[#2a2c2e] overflow-hidden">
            <div className="p-4 border-b border-[#2a2c2e] flex items-center justify-between bg-[#2a2c2e]/30">
              ...
              <span className="text-xs text-gray-400">Total {anime.episodes?.length}</span>
            </div>
